  ...
  return (
    <div className="landing-light">
      ...
      <section style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        {/* Content */}
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: 800, margin: '0 auto', padding: '48px 40px 40px', transform: `translateY(${scrollY * 0.12}px)`, background: 'rgba(255,255,255,0.55)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderRadius: 32, border: '1px solid rgba(255,255,255,0.4)' }}>
          ...
          <p style={{ fontSize: 'clamp(1rem, 2vw, 1.25rem)', color: 'rgba(15,17,21,0.8)', maxWidth: 560, margin: '0 auto 40px', lineHeight: 1.7, fontWeight: 400 }}>
            {fr
