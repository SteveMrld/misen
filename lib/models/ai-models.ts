...
export const AI_MODELS: Record<AIModelId, AIModelConfig> = {
  ...
  'seedance2': {
    ...
    negativePrefix: 'Not:', speciality: 'Mouvement pur, prompts courts',
    resolution: 8, maxDuration: 6, motion: 10, physics: 9,
    hands: 6, lipSync: 5, cameraControl: 7, lighting: 7,
    vfx: 8, consistency: 6, textRendering: 4, styleRange: 7,
    audioGen: 2, speed: 9, costPer10s: 0.05,
    supportsNegativePrompt: true, supportsImageToVideo: true,
    supportsCameraPath: false, maxResolution: '1080p',
  },
  'wan2.5': {
