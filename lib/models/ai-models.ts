...
export const AI_MODELS: Record<AIModelId, AIModelConfig> = {
  'kling3': {
    ...
    negativePrefix: 'Negative:', speciality: 'Motion Master : 4K natif 60fps, multi-shot (6 cuts/16s), physique réaliste',
    resolution: 9, maxDuration: 9, motion: 9, physics: 10,
    hands: 8, lipSync: 6, cameraControl: 8, lighting: 9,
    vfx: 6, consistency: 8, textRendering: 5, styleRange: 6,
  ...
  'runway4.5': {
    ...
    negativePrefix: '--no', speciality: 'Style brut, contrôle I2V/keyframes/V2V, vitesse/bas coût (social)',
