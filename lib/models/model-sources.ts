...
export const MODEL_SOURCES: Record<string, ModelSources> = {
  'kling3': {
    ...
    scores: {
      physics:       { score: 10, basis: 'benchmark', source: 'Kling 2.1→3.0 physics comparisons, AI video community consensus 2024-2025', confidence: 'high', lastVerified: '2025-03' },
      motion:        { score: 9,  basis: 'benchmark', source: 'Multi-model motion quality comparisons on YouTube (Tokenized AI, Matt Wolfe)', confidence: 'medium', lastVerified: '2025-02' },
      resolution:    { score: 9,  basis: 'spec', source: 'Kuaishou official: 1080p native output', confidence: 'high', lastVerified: '2025-03' },
      ...
      consistency:   { score: 8,  basis: 'community', source: 'Character consistency decent but Hailuo generally preferred', confidence: 'medium', lastVerified: '2025-02' },
  ...
  'seedance2': {
    ...
    scores: {
      physics:       { score: 9,  basis: 'benchmark', source: 'ByteDance focused on physics — TikTok dance motion expertise', confidence: 'medium', lastVerified: '2025-02' },
      motion:        { score: 10, basis: 'benchmark', source: 'Industry-leading motion quality, specifically designed for movement', confidence: 'high', lastVerified: '2025-03' },
      resolution:    { score: 8,  basis: 'spec', source: '1080p output', confidence: 'high', lastVerified: '2025-02' },
      hands:         { score: 6,  basis: 'community', source: 'Hands less focus, motion is priority', confidence: 'low', lastVerified: '2025-01' },
      lipSync:       { score: 5,  basis: 'estimated', source: 'Not dialogue-focused, movement-first model', confidence: 'low', lastVerified: '2025-01' },
      ...
      consistency:   { score: 6,  basis: 'community', source: 'Consistency not primary focus, some drift on longer clips', confidence: 'low', lastVerified: '2025-01' },
      ...
      audioGen:      { score: 2,  basis: 'spec', source: 'No built-in audio generation', confidence: 'high', lastVerified: '2025-02' },
